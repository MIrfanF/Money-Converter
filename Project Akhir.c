...
int main(){
	...
	{
		printf("Input yang anda masukan tidak ada dalam pilihan menu!\nSilahkan Masukan ulang input!");
		system("pause");
		system("cls");
		goto menu;
	}
	system ("cls");//menghapus yang ada pada layar//
} 
